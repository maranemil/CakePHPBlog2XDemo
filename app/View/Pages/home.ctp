...
<?php if (file_exists(WWW_ROOT . 'css' . DS . 'cake.generic.css')): ?>
    <p id="url-rewriting-warning" style="background-color:#e32; color:#fff;">
        ...
        1) <a target="_blank" href="https://book.cakephp.org/2.0/en/installation/url-rewriting.html"
...
<ul>
    ...
    <li><a href="https://discourse.cakephp.org/">CakePHP Official Forum </a>
        <ul>
            <li>CakePHP discussion forum</li>
        </ul>
    </li>
    <li><a href="https://discourse.cakephp.org/"><?php echo __d('cake_dev', 'CakePHP Official Forum'); ?> </a>
        <ul>
